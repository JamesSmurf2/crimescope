  ...
  return (
    <div className="drawer">
      ...
      <div className="drawer-content">
        {/* Page content here */}
        <label htmlFor="my-drawer-1" className="fixed top-[25px] left-[25px] bg-neutral-500/30 rounded-xl h-[50px] w-[50px] flex items-center justify-center z-1"><Menu /></label>
      </div>
